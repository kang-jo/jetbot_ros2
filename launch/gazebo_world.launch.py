...
def generate_launch_description():
    ...
    robot_x = DeclareLaunchArgument('x', default_value='-0.062859')
    robot_y = DeclareLaunchArgument('y', default_value='4.488687')
    robot_z = DeclareLaunchArgument('z', default_value='-0.043600')
    robot_roll = DeclareLaunchArgument('roll', default_value='-0.000054')
    robot_pitch = DeclareLaunchArgument('pitch', default_value='0.014516')
    robot_yaw = DeclareLaunchArgument('yaw', default_value='0.003262')


    world_file_name = 'maze_d1.world'
