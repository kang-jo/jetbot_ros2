...
def generate_launch_description():
    ...
    robot_x = DeclareLaunchArgument('x', default_value='-0.206311')
    robot_y = DeclareLaunchArgument('y', default_value='0.030358')
    robot_z = DeclareLaunchArgument('z', default_value='-0.043600')
    robot_roll = DeclareLaunchArgument('roll', default_value='-0.000027')
    robot_pitch = DeclareLaunchArgument('pitch', default_value='-0.026205')
    robot_yaw = DeclareLaunchArgument('yaw', default_value='0.006055')


    world_file_name = 'test1.world'
