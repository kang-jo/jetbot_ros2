...
def generate_launch_description():
    ...
    robot_x = DeclareLaunchArgument('x', default_value='-0.030938')
    robot_y = DeclareLaunchArgument('y', default_value='-0.006673')
    robot_z = DeclareLaunchArgument('z', default_value='-0.043600')
    robot_roll = DeclareLaunchArgument('roll', default_value='-0.000031')
    robot_pitch = DeclareLaunchArgument('pitch', default_value='-0.026205')
    robot_yaw = DeclareLaunchArgument('yaw', default_value='0.003409')


    world_file_name = 'test3.world'
