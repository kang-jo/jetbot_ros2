...
def main(args=None):
    ...
    request.initial_pose.orientation.x = float(node.get_parameter('roll').value)
    request.initial_pose.orientation.y = float(node.get_parameter('pitch').value)
    request.initial_pose.orientation.z = float(node.get_parameter('yaw').value)
