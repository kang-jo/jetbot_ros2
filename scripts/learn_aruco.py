...
# -*- coding: utf-8 -*-
"""
learning_node_3sonar5bin_aruco_sim.py

SARSA tabular untuk simulasi JetBot tanpa odometry dan tanpa HITL.
...
class LearningNode3Sonar5BinAruco(Node):
    ...
    def _control_loop_impl(self) -> None:
        ...
        if self.prev_state_idx is None:
            ...
            action = self.agent.choose_action(s_idx)
        ...
        if done:
            ...
            next_action = self.agent.choose_action(s_idx)
